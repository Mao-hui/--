...
.news-section {
  ...
  .news-card {
    ...
    min-height: 300px; // Add min-height for mobile
    ...
    .news-title {
      ...
      font-weight: 600;
      flex: 1;
      display: block; // Change to block to allow natural wrapping
...
@media (max-width: 768px) {
  ...
  .news-image {
    aspect-ratio: 16/9; // 调整为更宽比例
    height: auto;
    width: 100%;
  }

  .news-title {
    padding: 12px 16px; // 增加水平padding以扩大内容区
    font-size: 15px;
  }
