        ...
        <div v-loading="loading" class="content-wrapper">
          ...
          <div v-else-if="productInfo" class="detail-main">
            ...
            <div class="detail-header">
              <h1 class="detail-title">{{ productInfo.name }}</h1>
              <div class="detail-meta" v-if="productInfo.tags && productInfo.tags.length">
                <el-tag 
            ...
            <!-- 产品描述 -->
            <div class="detail-description" v-if="productInfo.description">
      ...
      try {
        ...
        if (res && res.code === 200 && res.data) {
          productInfo.value = {
            ...
            content: res.data.content || res.data.description || '<p>暂无详细内容</p>',
            tags: res.data.tags || []
          }
