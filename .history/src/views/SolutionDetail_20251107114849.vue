    ...
    const loadSolutionDetail = async () => {
      ...
      try {
        ...
        if (res && res.code === 200 && res.data) {
          ...
          // 提取图片URL
          const imageUrl = res.data.smallIndustryUrl || res.data.bigIndustryUrl || res.data.smallUrl || res.data.url || ''
          console.log('提取的图片URL:', imageUrl)
          console.log('smallIndustryUrl:', res.data.smallIndustryUrl)
          console.log('bigIndustryUrl:', res.data.bigIndustryUrl)
